#' d.ind.t
#'
#' This function Displays Cohen's d and confidence interval for independent t from means.
#'
...
#' @export
#' @examples
#' d.ind.t(m1=20, m2=17, sd1=4, sd2=5, n1=100, n2 = 100, a = .05, k = 2)


d.ind.t <- function (m1, m2, sd1, sd2, n1, n2, a = .05, k = 2) {
